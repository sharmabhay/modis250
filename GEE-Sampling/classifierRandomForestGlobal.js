...
Map.addLayer(ee.Image(classifiedImageList.get(7)), null, "Deciduous Needleleaf Forests");
Map.addLayer(ee.Image(classifiedImageList.get(8)), null, "Non-Vegetated Lands");
Map.addLayer(ee.Image(classifiedImageList.get(9)), null, "Urban and Built-up Lands");
